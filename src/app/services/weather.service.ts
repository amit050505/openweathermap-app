...
export class WeatherService {
  ...
  getWeatherForCitiesByCity(city: string) {
    return this.http.get<WeatherDetailsResponse>(`http://api.openweathermap.org/data/2.5/weather?q=${city}&appid=3d8b309701a13f65b660fa2c64cdc517`);
  }
